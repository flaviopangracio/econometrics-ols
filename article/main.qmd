...
Conforme Wooldrige (2010), para um estimador ser consistente, são necessárias duas premissas. A primeira implica que a covariância entre o resíduo e o vetor de variáveis explicativas seja igual a zero e essa é uma versão mais fraca da exogeneidade. Por outro lado, a segunda premissa diz que a multiplicação matricial de x e sua transposta tem que ser igual a ordem de x, ou seja, implica independência linear. 
(Colocar formula - livro wooldrige)
...
summary(mqo) -->
>>>>>>> db089affbc67b253de714c6cd715abaeb201309e
